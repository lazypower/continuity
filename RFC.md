...
*Revised in v0.5.1 (issue #72): L2 previously read "Raw observations, full transcripts." Raw observations are no longer a permanent L2 surface — see the revision note in §4.3.*
...
> **Revised in v0.5.1 (issue #72): `mem://sessions/abc123/observations` is withdrawn.**
>
